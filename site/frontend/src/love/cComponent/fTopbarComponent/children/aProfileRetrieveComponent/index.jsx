...
const ProfileRetrieveComponent = ({ Redux }) => {
  ...
  return (
    <React.Fragment>
      <section class="bg-[#FCEDDA] dark:bg-[#EE4E34] text-[#EE4E34] dark:text-[#FCEDDA] lg:px-20">
            ...
            <div class="flex flex-col sm:flex-row mt-10">
              <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                ...
                <div class="flex flex-col items-center text-center justify-center">
                  ...
                  <div class="w-12 h-1 bg-[#EE4E34] dark:bg-[#FCEDDA] rounded mt-2 mb-4"></div>
        ...
        <div class="container px-5 py-12 mx-auto">
          <div class="flex flex-wrap -m-4">
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-[#EE4E34] dark:border-[#FCEDDA] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#EE4E34] dark:border-[#FCEDDA] leading-none">Critical Information</h1>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-[#EE4E34] dark:border-[#FCEDDA] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#EE4E34] dark:border-[#FCEDDA] leading-none">Basic Information</h1>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-[#EE4E34] dark:border-[#FCEDDA] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#EE4E34] dark:border-[#FCEDDA] leading-none">Relation Information</h1>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-[#EE4E34] dark:border-[#FCEDDA] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#EE4E34] dark:border-[#FCEDDA] leading-none">More Information</h1>

              ...
              return (
                <React.Fragment key={index} >
                  <div className="p-4 md:w-1/2">
                    <div className="flex rounded-lg h-full bg-[#EE4E34] dark:bg-[#FCEDDA] text-[#FCEDDA] dark:text-[#EE4E34] bg-opacity-60 p-8 flex-col">
                      <div className="flex items-center mb-3">
                        <div className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-[#FCEDDA] dark:bg-[#EE4E34] text-[#EE4E34] dark:text-[#FCEDDA] flex-shrink-0">
